...
#### 2. Task Analysis | Ern Qi<br>
Allows users to look at trends in their tasks by creating charts and graphs based on the data generated by the user's behaviour on the app.
...
#### 3. Text Input Layout/ Edit Texts:
