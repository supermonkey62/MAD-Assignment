...
//public class PomodoroTimer extends AppCompatActivity {
//    private static final long WORK_TIME = 2 * 60 * 1000; // 25 minutes in milliseconds
//    private static final long REST_TIME = 1 * 60 * 1000; // 5 minutes in milliseconds
//    private static final long LONG_BREAK_TIME = 3 * 60 * 1000; // 15 minutes in milliseconds
//    private static final int POMODORO_SET_SIZE = 2;
//
//    private long timeLeftInMillis;
...
//        textView = findViewById(R.id.pomotext);
//        progressBar = findViewById(R.id.progressBar);
//
...
//
//            if (pomodoroCount % POMODORO_SET_SIZE == 0 && pomodoroCount != 0) {
//                setTime(LONG_BREAK_TIME);
//                pomodoroCount = 0;
//            } else if (pomodoroCount % POMODORO_SET_SIZE != 0) {
//                setTime(REST_TIME);
//            } else {
//                setTime(WORK_TIME);
//            }
...
//                    else {
//
//                        if (pomodoroCount != 1 && timeLeftInMillis == REST_TIME) {
//                            pomodoroCount++;
//                        }
//
//                        startTimer();
...
////                        Toast.makeText(PomodoroTimer.this, "Halfway done!", Toast.LENGTH_SHORT).show();
////                    }
//
//                    if (minutes == 5 && seconds == 0) {
//                        Toast.makeText(PomodoroTimer.this, "5 minutes remaining!", Toast.LENGTH_SHORT).show();
